...
(setq user-full-name "Oscar Vargas Torres"
      user-mail-address "vargas.torres.oscar@gmail.com")
...
(setq org-journal-dir "~/Dropbox/journal"
      org-journal-file-format "%Y-%b-%d.org.gpg"
...
(defun show-docs ()
  "Runs `lsp-ui-doc-show' and then `lsp-ui-doc-focus-frame'"
  (interactive)
  (lsp-ui-doc-show)
  (lsp-ui-doc-focus-frame))

(defun hide-docs ()
  "Runs `lsp-ui-doc-unfocus-frame' and then `lsp-ui-doc-hide'"
  (interactive)
